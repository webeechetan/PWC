        ...
        <div class="row mb-5">
            <div class="col-md-12 text-center">
                ...
                @foreach($seasons as $season)
                    @if($season->is_active)
                        <a href="{{ route('startup.list') }}"><button class="btn btn-sm btn-success">{{ $season->season }}</button></a>
                    @else
                        <a href="{{ route('startup.list.by.season',$season->id) }}"><button class="btn btn-sm btn-warning">{{ $season->season }}</button></a>
                    @endif
                @endforeach
            </div>
                ...
                <form name="startup">
                    <div class="sidebar">
                        ...
                        <div class="sidebar-inner mt-3 mt-lg-0">
                            ...
                            <input type="hidden" name="use_scope" value="@if($use_scope) 1 @endif">
                            <div class="sidebar-item">
                    ...
                    <div class="card-body">
                        <div class="row align-items-end">
                            <div class="col-lg-8">
                                <div class="card-body-left">
                                    ...
                                    <div>
                                        ...
                                        else if(d.meeting1.length === 0) element += getAction(d.id, 'meeting1', 'Stage 2')//d.screening_count > 3 
                                        else if(d.finalcall.length === 0) element += getAction(d.id, 'finalcall', 'Stage 3')//d.meeting2_count > 3
                            ...
                            element += `<div data-target-company="${d.id}">`
                                ...
                                if(d.finalcall.length === 1) element += getStatus(d.finalcall[0], 'Stage 3')
                            element += `</div>`
